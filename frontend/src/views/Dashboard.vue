<template>
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6 md:mb-8">
    <div class="bg-white rounded-lg shadow-md p-4 md:p-6">
      <div class="flex items-center justify-between">
        <div>
          <p class="text-gray-500 text-sm md:text-base">总图书数</p>
          <p class="text-2xl md:text-3xl font-bold text-gray-800">{{ stats.totalBooks }}</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-4 md:p-6">
      <div class="flex items-center justify-between">
        <div>
          <p class="text-gray-500 text-sm md:text-base">可借阅</p>
          <p class="text-2xl md:text-3xl font-bold text-green-600">{{ stats.availableBooks }}</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-4 md:p-6">
      <div class="flex items-center justify-between">
        <div>
          <p class="text-gray-500 text-sm md:text-base">借阅中</p>
          <p class="text-2xl md:text-3xl font-bold text-blue-600">{{ stats.borrowedBooks }}</p>
        </div>
        <div class="bg-blue-100 p-2 md:p-3 rounded-full">
          <svg class="w-5 h-5 md:w-6 md:h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-white rounded-lg shadow-md p-4 md:p-6">
      <div class="flex items-center justify-between">
        <div>
          <p class="text-gray-500 text-sm md:text-base">用户总数</p>
          <p class="text-2xl md:text-3xl font-bold text-purple-600">{{ stats.totalUsers }}</p>
        </div>
  ...
  <div class="bg-white rounded-lg shadow-md p-4 md:p-6">
    <h3 class="text-lg md:text-xl font-bold text-gray-800 mb-4">最新借阅记录</h3>
    ...
    <div class="md:hidden space-y-3">
      ...
      >
        ...
        <div class="text-sm text-gray-600 space-y-1">
          <p><span class="font-medium">借阅人：</span>{{ record.username }}</p>
